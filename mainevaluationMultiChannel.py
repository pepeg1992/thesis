...
from SLOCevaluationfunctionhscma import evaluationMultiChannel
...
fileToWrite='Multi_Channel'+dir_training+'/risultati.txt'
...
for sizekernelCNN in [3,4,5]:
    for stridesCNN in [1,2,3,4,5]:
        ...
        evaluationMultiChannel(fileToWrite,nameplace,context,CNNkernel,sizekernelCNN,stridesCNN,DenseNeuron)
CNNkernel=[256]
for sizekernelCNN in [3,4,5]:
    for stridesCNN in [1,2,3,4,5]:
        print 'kernel size: '+str(int(sizekernelCNN))  
